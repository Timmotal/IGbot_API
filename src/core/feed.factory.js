...
var FeedFactory = /** @class */ (function () {
    ...
    FeedFactory.prototype.accountFollowers = function (options) {
        return (0, class_transformer_1.plainToClassFromExist)(new feeds_1.AccountFollowersFeed(this.client), __assign({ id: options && typeof options !== 'object' ? options : this.client.state.cookieUserId }, (typeof options === 'object' ? options : undefined)));
    };
    FeedFactory.prototype.accountFollowing = function (options) {
        return (0, class_transformer_1.plainToClassFromExist)(new feeds_1.AccountFollowingFeed(this.client), __assign({ id: options && typeof options !== 'object' ? options : this.client.state.cookieUserId }, (typeof options === 'object' ? options : undefined)));
    };
    ...
    FeedFactory.prototype.bestFriendships = function () {
    ...
    FeedFactory.prototype.userStory = function (userId) {
        return (0, class_transformer_1.plainToClassFromExist)(new user_story_feed_1.UserStoryFeed(this.client), { userId: userId });
    };
    FeedFactory.prototype.reelsTray = function (reason) {
        if (reason === void 0) { reason = 'cold_start'; }
        return (0, class_transformer_1.plainToClassFromExist)(new feeds_1.ReelsTrayFeed(this.client), { reason: reason });
    };
    ...
    FeedFactory.prototype.musicTrending = function (product) {
        ...
        return (0, class_transformer_1.plainToClassFromExist)(new feeds_1.MusicTrendingFeed(this.client), { product: product });
    };
    ...
    FeedFactory.prototype.usertags = function (id) {
        return (0, class_transformer_1.plainToClassFromExist)(new feeds_1.UsertagsFeed(this.client), { id: id });
    };
    FeedFactory.prototype.postsInsightsFeed = function (options) {
        return (0, class_transformer_1.plainToClassFromExist)(new feeds_1.PostsInsightsFeed(this.client), { options: options });
    };
    FeedFactory.prototype.storiesInsights = function (timeframe) {
        return (0, class_transformer_1.plainToClassFromExist)(new feeds_1.StoriesInsightsFeed(this.client), { timeframe: timeframe });
    };
    ...
    FeedFactory.prototype.listReelMediaViewers = function (mediaId) {
        return (0, class_transformer_1.plainToClassFromExist)(new list_reel_media_viewer_feed_1.ListReelMediaViewerFeed(this.client), { mediaId: mediaId });
    };
    ...
    FeedFactory.prototype.igtvChaining = function (id) {
        return this.igtvChannel("chaining_".concat(id));
    };
    FeedFactory.prototype.liked = function () {
        return new feeds_1.LikedFeed(this.client);
    };
    FeedFactory.prototype.topicalExplore = function (options) {
