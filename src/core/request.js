...
var Request = /** @class */ (function () {
    ...
    Request.prototype.send = function (userOptions, onlyCheckHttpStatus) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = (0, lodash_1.defaultsDeep)(userOptions, {
                        ...
                        Request.requestDebug("Requesting ".concat(options.method, " ").concat(options.url || options.uri || '[could not find url]'));
    ...
    Request.prototype.sign = function (payload) {
        ...
        return {
            ...
            signed_body: "".concat(signature, ".").concat(json),
        };
    };
    Request.prototype.userBreadcrumb = function (size) {
        var term = (0, lodash_1.random)(2, 3) * 1000 + size + (0, lodash_1.random)(15, 20) * 1000;
        var textChangeEventCount = Math.round(size / (0, lodash_1.random)(2, 3)) || 1;
        var data = "".concat(size, " ").concat(term, " ").concat(textChangeEventCount, " ").concat(Date.now());
        var signature = Buffer.from((0, crypto_1.createHmac)('sha256', this.client.state.userBreadcrumbKey)
            .update(data)
    ...
    Request.prototype.handleResponseError = function (response) {
        Request.requestDebug("Request ".concat(response.request.method, " ").concat(response.request.uri.path, " failed: ").concat(typeof response.body === 'object' ? JSON.stringify(response.body) : response.body));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, attempt_1.retry)(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
    ...
    Request.prototype.getDefaultHeaders = function () {
        ...
        return {
            ...
            'X-IG-Connection-Speed': "".concat((0, lodash_1.random)(1000, 3700), "kbps"),
