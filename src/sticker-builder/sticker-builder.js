...
var StickerBuilder = /** @class */ (function () {
    ...
    StickerBuilder.prototype.build = function () {
        ...
        return __assign(__assign(__assign({}, lodash_1.defaults.apply(void 0, __spreadArray([{}], additionalProperties, false))), result), { story_sticker_ids: ids.join(',') });
    };
    ...
    StickerBuilder.quiz = function (options) {
        return (0, class_transformer_1.plainToClass)(stickers_1.QuizSticker, __assign({ width: 0.7291667, height: 0.11824318 + options.options.length * 0.10304056 }, options));
    };
