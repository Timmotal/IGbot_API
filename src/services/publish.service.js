    ...
    PublishService.catchTranscodeError = function (videoInfo, transcodeDelayInMs) {
        return function (error) {
            if (error.response.statusCode === 202) {
                PublishService.publishDebug("Received trancode error: ".concat(JSON.stringify(error.response.body), ", waiting ").concat(transcodeDelayInMs, "ms"));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        PublishService.publishDebug("Publishing video to timeline: ".concat(JSON.stringify(videoInfo)));
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        _loop_1 = function (item) {
                            var uploadedPhoto, _c, width, height;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 3:
                                        ...
                                        PublishService.publishDebug("Adding video to album: ".concat(JSON.stringify(item.videoInfo)));
                                        return [4 /*yield*/, Bluebird.try(function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (typeof options.hashtags !== 'undefined' && options.hashtags.length > 0) {
                    ...
                    options.hashtags.forEach(function (hashtag) {
                        ...
                        if (!options.caption.includes(hashtag.tag_name)) {
                            options.caption = "".concat(options.caption, " ").concat(hashtag.tag_name);
                        }
                    });
                ...
                if (typeof options.slider !== 'undefined') {
                    ...
                    storyStickerIds.push("emoji_slider_".concat(options.slider.emoji));
                }
                ...
                if (typeof options.media !== 'undefined') {
                    ...
                    storyStickerIds.push("media_simple_".concat(options.media.media_id));
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        videoInfo = PublishService.getVideoInfo(options.video);
                        PublishService.publishDebug("Publishing video to igtv: ".concat(JSON.stringify(videoInfo)));
                        uploadId = Date.now().toString();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        options.uploadName = options.uploadName || "".concat(options.uploadId, "_0_").concat((0, lodash_1.random)(1000000000, 9999999999));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        waterfallId = options.waterfallId || (0, lodash_1.random)(1000000000, 9999999999).toString();
                    ...
                    case 1:
                        ...
                        PublishService.publishDebug("Uploading ".concat(segments.length, " segments."));
                        startOffset = 0;
                    ...
                    case 2:
                        ...
                        transferId = "".concat(this.chance.guid({ version: 4 }).replace('-', ''), "-0-").concat(segment.byteLength);
    ...
    PublishService.prototype.uploadAndConfigureStoryVideo = function (options, configureOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        uploadId = (0, lodash_1.random)(100000000000, 999999999999).toString();
                        videoInfo = PublishService.getVideoInfo(options.video);
                        PublishService.publishDebug("Publishing video to story: ".concat(JSON.stringify(videoInfo)));
                        waterfallId = this.chance.guid({ version: 4 });
                        return [4 /*yield*/, Bluebird.try(function () {
