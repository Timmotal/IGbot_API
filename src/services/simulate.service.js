...
var SimulateService = /** @class */ (function (_super) {
    ...
    Object.defineProperty(SimulateService.prototype, "preLoginFlowRequests", {
        get: function () {
            var _this = this;
            return [
                function () { return _this.client.account.readMsisdnHeader().catch(function () { return undefined; }); },
                function () { return _this.client.account.msisdnHeaderBootstrap('ig_select_app').catch(function () { return undefined; }); },
                function () { return _this.client.zr.tokenResult(); },
                function () { return _this.client.account.contactPointPrefill('prefill').catch(function () { return undefined; }); },
                ...
                function () { return _this.client.account.getPrefillCandidates().catch(function () { return undefined; }); },
            ];
        },
        enumerable: false,
        configurable: true
    ...
    SimulateService.executeRequestsFlow = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var requests = _b.requests, _c = _b.concurrency, concurrency = _c === void 0 ? 1 : _c, _d = _b.toShuffle, toShuffle = _d === void 0 ? true : _d;
