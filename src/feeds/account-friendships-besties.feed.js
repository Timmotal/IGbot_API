...
var BestiesFeed = function () {
    ...
    return _a = /** @class */ (function (_super) {
            __extends(BestiesFeed, _super);
            function BestiesFeed() {
            ...
            Object.defineProperty(BestiesFeed.prototype, "state", {
                set: function (body) {
            ...
            BestiesFeed.prototype.request = function () {
            ...
            BestiesFeed.prototype.items = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var body;
                    var _this = this;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                body = _b.sent();
                                return [2 /*return*/, body.users.map(function (user) { return (0, class_transformer_1.plainToClassFromExist)(new responses_1.BestiesFeedResponseUsersItem(_this.client), user); })];
                        }
                    });
                });
            };
