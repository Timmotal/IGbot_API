...
var AccountFollowingFeed = function () {
    var _a;
    ...
    return _a = /** @class */ (function (_super) {
            ...
            function AccountFollowingFeed() {
                ...
                _this.order = 'default';
                _this.query = '';
                _this.enableGroups = true;
                _this.includesHashtags = true;
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, this.client.request.send({
                                    url: "/api/v1/friendships/".concat(this.id, "/following/"),
                                    qs: {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                body = _b.sent();
                                return [2 /*return*/, body.users.map(function (user) { return (0, class_transformer_1.plainToClassFromExist)(new responses_1.AccountFollowingFeedResponseUsersItem(_this.client), user); })];
                        }
                    });
                });
            };
