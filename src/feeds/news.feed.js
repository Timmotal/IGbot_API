                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                body = _b.sent();
                                return [2 /*return*/, body.stories.map(function (user) { return (0, class_transformer_1.plainToClassFromExist)(new responses_1.NewsFeedResponseStoriesItem(_this.client), user); })];
                        }
                    });
                });
            };
