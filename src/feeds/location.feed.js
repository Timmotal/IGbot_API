                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, this.client.request.send({
                                    url: "/api/v1/locations/".concat(this.id, "/sections/"),
                                    method: 'POST',
                                    form: {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                response = _b.sent();
                                return [2 /*return*/, (0, lodash_1.flatten)(response.sections.map(function (section) { return section.layout_content.medias.map(function (medias) { return medias.media; }); }))];
                        }
                    });
                });
            };
