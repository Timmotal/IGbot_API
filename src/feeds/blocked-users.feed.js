                        ...
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [2 /*return*/, body.blocked_list.map(function (user) {
                                        return (0, class_transformer_1.plainToClassFromExist)(new responses_1.BlockedUsersFeedResponseBlockedListItem(_this.client), user);
                                    })];
                        }
                    });
                });
