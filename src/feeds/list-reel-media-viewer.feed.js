...
var ListReelMediaViewerFeed = function () {
    var _a;
    ...
    return _a = /** @class */ (function (_super) {
            ...
            function ListReelMediaViewerFeed() {
                ...
                _this.nextMaxId = (__runInitializers(_this, _mediaId_extraInitializers), __runInitializers(_this, _nextMaxId_initializers, undefined));
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4 /*yield*/, this.client.request.send({
                                    url: "/api/v1/media/".concat(this.mediaId, "/list_reel_media_viewer"),
                                    method: 'GET',
                                    qs: {
        ...
        (function () {
            ...
            _mediaId_decorators = [(0, class_transformer_1.Expose)()];
