...
var PendingFriendshipsFeed = function () {
    var _a;
                        ...
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                return [2 /*return*/, body.users.map(function (user) {
                                        return (0, class_transformer_1.plainToClassFromExist)(new responses_1.PendingFriendshipsFeedResponseUsersItem(_this.client), user);
                                    })];
                        }
                    });
                });
