...
var PostsInsightsFeed = function () {
    var _a;
    ...
    return _a = /** @class */ (function (_super) {
            ...
            function PostsInsightsFeed() {
                ...
                _this.nextCursor = __runInitializers(_this, _nextCursor_initializers, null);
            ...
            Object.defineProperty(PostsInsightsFeed.prototype, "state", {
                set: function (response) {
                    var _b = response.data.user.business_manager.top_posts_unit.top_posts.page_info, end_cursor = _b.end_cursor, has_next_page = _b.has_next_page;
