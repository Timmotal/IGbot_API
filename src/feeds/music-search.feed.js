...
var MusicSearchFeed = function () {
    ...
    var _searchSessionId_decorators;
    var _searchSessionId_initializers = [];
    var _searchSessionId_extraInitializers = [];
    return _a = /** @class */ (function (_super) {
            ...
            function MusicSearchFeed() {
                ...
                _this.query = (__runInitializers(_this, _product_extraInitializers), __runInitializers(_this, _query_initializers, void 0));
                _this.searchSessionId = (__runInitializers(_this, _query_extraInitializers), __runInitializers(_this, _searchSessionId_initializers, void 0));
                __runInitializers(_this, _searchSessionId_extraInitializers);
                return _this;
            }
        ...
        (function () {
            ...
            _query_decorators = [(0, class_transformer_1.Expose)()];
            _searchSessionId_decorators = [(0, class_transformer_1.Expose)()];
            ...
            __esDecorate(null, null, _searchSessionId_decorators, { kind: "field", name: "searchSessionId", static: false, private: false, access: { has: function (obj) { return "searchSessionId" in obj; }, get: function (obj) { return obj.searchSessionId; }, set: function (obj, value) { obj.searchSessionId = value; } }, metadata: _metadata }, _searchSessionId_initializers, _searchSessionId_extraInitializers);
