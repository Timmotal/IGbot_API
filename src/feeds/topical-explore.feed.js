...
var TopicalExploreFeed = function () {
    var _a;
    ...
    return _a = /** @class */ (function (_super) {
            __extends(TopicalExploreFeed, _super);
            function TopicalExploreFeed() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.module = 'explore_popular';
                /**
                 * Change this to set the category
                 */
                _this.clusterId = 'explore_all:0';
                _this.sessionId = chance.guid({ version: 4 });
                _this.nextMaxId = __runInitializers(_this, _nextMaxId_initializers, void 0);
                __runInitializers(_this, _nextMaxId_extraInitializers);
                return _this;
            }
            Object.defineProperty(TopicalExploreFeed.prototype, "state", {
                set: function (body) {
            ...
            TopicalExploreFeed.prototype.items = function () {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                res = _b.sent();
                                return [2 /*return*/, res.sectional_items];
                        }
                    });
                });
            };
            TopicalExploreFeed.prototype.request = function () {
                return __awaiter(this, void 0, void 0, function () {
                    var body;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
