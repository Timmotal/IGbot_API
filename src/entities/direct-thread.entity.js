...
var DirectThreadEntity = /** @class */ (function (_super) {
     ...
     */
    DirectThreadEntity.prototype.broadcastText = function (text, skipLinkCheck) {
        return __awaiter(this, void 0, void 0, function () {
            var urls;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!skipLinkCheck) {
                            urls = text.match(require('url-regex-safe')({ strict: false }));
    ...
    DirectThreadEntity.prototype.broadcastPost = function (mediaId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.broadcast({
