...
var UploadRepository = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        name = "".concat(uploadId, "_0_").concat((0, lodash_1.random)(1000000000, 9999999999));
                        contentLength = options.file.byteLength;
                        UploadRepository.uploadDebug("Uploading ".concat(options.file.byteLength, "b as ").concat(uploadId, " (photo, jpeg)"));
                        return [4 /*yield*/, this.client.request.send({
                                url: "/rupload_igphoto/".concat(name),
                                method: 'POST',
                                headers: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        video = options.video;
                        uploadId = options.uploadId || Date.now();
                        name = options.uploadName || "".concat(uploadId, "_0_").concat((0, lodash_1.random)(1000000000, 9999999999));
                        ...
                        UploadRepository.uploadDebug("Uploading ".concat(options.video.byteLength, "b as ").concat(uploadId, " (video, mp4, not segmented). Info: ").concat(JSON.stringify(ruploadParams)));
                        return [4 /*yield*/, this.client.request.send({
                                url: "/rupload_igvideo/".concat(name),
                                method: 'POST',
                                qs: {
    ...
    UploadRepository.prototype.initVideo = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var body;
            var name = _b.name, ruploadParams = _b.ruploadParams, waterfallId = _b.waterfallId;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        UploadRepository.uploadDebug("Initializing video upload: ".concat(JSON.stringify(ruploadParams)));
                        return [4 /*yield*/, this.client.request.send({
                                url: "/rupload_igvideo/".concat(name),
                                method: 'GET',
    ...
    UploadRepository.prototype.startSegmentedVideo = function (ruploadParams) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        UploadRepository.uploadDebug("Starting segmented video upload: ".concat(JSON.stringify(ruploadParams)));
                        return [4 /*yield*/, this.client.request.send({
                                url: "/rupload_igvideo/".concat(this.chance.guid({ version: 4 })),
                                qs: {
                                    segmented: true,
                                    phase: 'start',
                                },
    ...
    UploadRepository.prototype.videoSegmentInit = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        UploadRepository.uploadDebug("Initializing segmented video upload: ".concat(JSON.stringify(options)));
                        return [4 /*yield*/, this.client.request.send({
                                url: "/rupload_igvideo/".concat(options.transferId),
                                method: 'GET',
                                qs: {
                                    segmented: true,
                                    phase: 'transfer',
    ...
    UploadRepository.prototype.videoSegmentTransfer = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        UploadRepository.uploadDebug("Transfering segmented video: ".concat(options.segment.byteLength, "b, stream position: ").concat(options.startOffset));
                        return [4 /*yield*/, this.client.request.send({
                                url: "/rupload_igvideo/".concat(options.transferId),
                                qs: {
                                    segmented: true,
    ...
    UploadRepository.prototype.endSegmentedVideo = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var body;
            var ruploadParams = _b.ruploadParams, streamId = _b.streamId;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        UploadRepository.uploadDebug("Ending segmented video upload of ".concat(streamId));
                        return [4 /*yield*/, this.client.request.send({
                                url: "/rupload_igvideo/".concat(this.chance.guid({ version: 4 })),
                                qs: {
                                    segmented: true,
