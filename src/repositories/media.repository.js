...
var MediaRepository = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/info/"),
                            method: 'GET',
    ...
    MediaRepository.prototype.editMedia = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var body;
            var mediaId = _b.mediaId, captionText = _b.captionText;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/edit_media/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                igtv_feed_preview: false,
                                media_id: mediaId,
    ...
    MediaRepository.prototype.delete = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var body;
            var mediaId = _b.mediaId, _c = _b.mediaType, mediaType = _c === void 0 ? 'PHOTO' : _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/delete/"),
                            method: 'POST',
                            qs: {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.request.send({
                                url: "/api/v1/media/".concat(options.mediaId, "/").concat(options.action, "/"),
                                method: 'POST',
    ...
    MediaRepository.prototype.likeComment = function (commentId) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(commentId, "/comment_like/"),
                            method: 'POST',
                        })];
                    case 1:
                        body = (_a.sent()).body;
    ...
    MediaRepository.prototype.unlikeComment = function (commentId) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(commentId, "/comment_unlike/"),
                            method: 'POST',
                        })];
                    case 1:
                        body = (_a.sent()).body;
    ...
    MediaRepository.prototype.commentsBulkDelete = function (mediaId, commentIds) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/comment/bulk_delete/"),
                            method: 'POST',
                            form: this.client.request.sign({
    ...
    MediaRepository.prototype.comment = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var body;
            var mediaId = _b.mediaId, text = _b.text, replyToCommentId = _b.replyToCommentId, _c = _b.module, module = _c === void 0 ? 'self_comments_v2' : _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/comment/"),
                            method: 'POST',
                            form: this.client.request.sign({
    ...
    MediaRepository.prototype.commentsDisable = function (mediaId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/disable_comments/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uid: this.client.state.cookieUserId,
    ...
    MediaRepository.prototype.commentsEnable = function (mediaId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/enable_comments/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uid: this.client.state.cookieUserId,
    ...
    MediaRepository.prototype.likers = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(id, "/likers/"),
                        })];
                    case 1:
                        body = (_a.sent()).body;
                        return [2 /*return*/, body];
    ...
    MediaRepository.prototype.applyConfigureDefaults = function (options, defaults) {
        ...
        return (0, lodash_1.defaultsDeep)(options, __assign({ _csrftoken: this.client.state.cookieCsrfToken, _uid: this.client.state.cookieUserId, _uuid: this.client.state.uuid, device: devicePayload, extra: { source_width: width, source_height: height } }, defaults));
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        now = Date.now();
                        devicePayload = this.client.state.devicePayload;
                        form = (0, lodash_1.defaultsDeep)(options, {
    ...
    MediaRepository.prototype.onlyMe = function (mediaId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/only_me/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                media_id: mediaId,
                                _csrftoken: this.client.state.cookieCsrfToken,
    ...
    MediaRepository.prototype.undoOnlyMe = function (mediaId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/undo_only_me/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                media_id: mediaId,
                                _csrftoken: this.client.state.cookieCsrfToken,
    ...
    MediaRepository.prototype.seen = function (reels_1) {
        return __awaiter(this, arguments, void 0, function (reels, module) {
            var body;
     ...
     */
    MediaRepository.prototype.save = function (mediaId, collection_ids) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/save/"),
                            method: 'POST',
                            form: this.client.request.sign({
    ...
    MediaRepository.prototype.unsave = function (mediaId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/unsave/"),
                            method: 'POST',
                        })];
                    case 1:
                        body = (_a.sent()).body;
    ...
    MediaRepository.prototype.storyPollVote = function (mediaId, pollId, vote) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/").concat(pollId, "/story_poll_vote/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                _csrftoken: this.client.state.cookieCsrfToken,
                                radio_type: this.client.state.radioType,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.request.send({
                                url: "/api/v1/media/".concat(mediaId, "/").concat(questionId, "/story_question_response/"),
                                method: 'POST',
    ...
    MediaRepository.prototype.storySliderVote = function (mediaId, sliderId, vote) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/").concat(sliderId, "/story_slider_vote/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uid: this.client.state.cookieUserId,
    ...
    MediaRepository.prototype.storyQuizAnswer = function (mediaId, quizId, answer) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(mediaId, "/").concat(quizId, "/story_quiz_answer/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
    ...
    MediaRepository.prototype.storyCountdownAction = function (countdownId, action) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/media/".concat(countdownId, "/").concat(action, "/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uid: this.client.state.cookieUserId,
    ...
    MediaRepository.prototype.storyCountdownFollow = function (countdownId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.storyCountdownAction(countdownId, 'follow_story_countdown')];
            });
        });
    };
    MediaRepository.prototype.storyCountdownUnfollow = function (countdownId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.storyCountdownAction(countdownId, 'unfollow_story_countdown')];
            });
        });
    };
