            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/highlights/".concat(userId, "/highlights_tray/"),
                            method: 'GET',
                            qs: {
    ...
    HighlightsRepository.prototype.editReel = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/highlights/".concat(options.highlightId, "/edit_reel/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                supported_capabilities_new: JSON.stringify(this.client.state.supportedCapabilities),
    ...
    HighlightsRepository.prototype.deleteReel = function (highlightId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/highlights/".concat(highlightId, "/delete_reel/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uid: this.client.state.cookieUserId,
