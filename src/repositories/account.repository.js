...
var AccountRepository = /** @class */ (function (_super) {
                        ...
                        return [4 /*yield*/, Bluebird.try(function () {
                                return _this.client.request.send({
                                    ...
                                    form: _this.client.request.sign({
                                        username: username,
                                        enc_password: "#PWD_INSTAGRAM:4:".concat(time, ":").concat(encrypted),
                                ...
                                if (error.response.body.two_factor_required) {
                                    AccountRepository.accountDebug("Login failed, two factor auth required: ".concat(JSON.stringify(error.response.body.two_factor_info)));
    ...
    AccountRepository.prototype.create = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            var body;
            var _this = this;
            var username = _b.username, password = _b.password, email = _b.email, first_name = _b.first_name;
    ...
    AccountRepository.prototype.command = function (command) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/accounts/".concat(command, "/"),
                            method: 'POST',
                            form: this.client.request.sign({
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uid: this.client.state.cookieUserId,
    ...
    AccountRepository.prototype.readMsisdnHeader = function () {
        return __awaiter(this, arguments, void 0, function (usage) {
            var body;
    ...
    AccountRepository.prototype.msisdnHeaderBootstrap = function () {
        return __awaiter(this, arguments, void 0, function (usage) {
            var body;
            if (usage === void 0) { usage = 'default'; }
            return __generator(this, function (_a) {
    ...
    AccountRepository.prototype.contactPointPrefill = function () {
        return __awaiter(this, arguments, void 0, function (usage) {
            var body;
            if (usage === void 0) { usage = 'default'; }
            return __generator(this, function (_a) {
