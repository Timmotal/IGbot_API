...
var FriendshipRepository = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/friendships/show/".concat(id, "/"),
                        })];
                    case 1:
                        body = (_a.sent()).body;
    ...
    FriendshipRepository.prototype.change = function (action, id, mediaIdAttribution) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/friendships/".concat(action, "/").concat(id, "/"),
                            method: 'POST',
    ...
    FriendshipRepository.prototype.setBesties = function () {
    ...
    FriendshipRepository.prototype.mutePostsOrStoryFromFollow = function (options) {
    ...
    FriendshipRepository.prototype.unmutePostsOrStoryFromFollow = function (options) {
        return this.changeMuteFromFollow('unmute', {
            target_reel_author_id: options.targetReelAuthorId,
            target_posts_author_id: options.targetPostsAuthorId,
        });
    };
    FriendshipRepository.prototype.changeMuteFromFollow = function (mode, options) {
        return __awaiter(this, void 0, void 0, function () {
            var body;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/friendships/".concat(mode, "_posts_or_story_from_follow/"),
                            method: 'POST',
                            form: __assign({ _csrftoken: this.client.state.cookieCsrfToken, _uid: this.client.state.cookieUserId, _uuid: this.client.state.uuid }, options),
                        })];
                    case 1:
                        body = (_a.sent()).body;
                        return [2 /*return*/, body];
