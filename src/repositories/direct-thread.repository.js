            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/approve/"),
                            method: 'POST',
                            form: {
    ...
    DirectThreadRepository.prototype.decline = function (threadId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/decline/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
    ...
    DirectThreadRepository.prototype.approveParticipantRequests = function (threadId, userIds) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/approve_participant_requests/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
    ...
    DirectThreadRepository.prototype.updateTitle = function (threadId, title) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/update_title/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
    ...
    DirectThreadRepository.prototype.mute = function (threadId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/mute/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
    ...
    DirectThreadRepository.prototype.unmute = function (threadId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/unmute/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
    ...
    DirectThreadRepository.prototype.addUser = function (threadId, userIds) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/add_user/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                user_ids: JSON.stringify(userIds),
    ...
    DirectThreadRepository.prototype.leave = function (threadId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/leave/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
    ...
    DirectThreadRepository.prototype.hide = function (threadId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/hide/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
    ...
    DirectThreadRepository.prototype.markItemSeen = function (threadId, threadItemId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/items/").concat(threadItemId, "/seen/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.request.send({
                                url: "/api/v1/direct_v2/threads/broadcast/".concat(options.item, "/"),
                                method: 'POST',
    ...
    DirectThreadRepository.prototype.deleteItem = function (threadId, itemId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.request.send({
                            url: "/api/v1/direct_v2/threads/".concat(threadId, "/items/").concat(itemId, "/delete/"),
                            method: 'POST',
                            form: {
                                _csrftoken: this.client.state.cookieCsrfToken,
                                _uuid: this.client.state.uuid,
